...
// libraries.  Replace DummyAligner throughout with the name
...
static Vamp::PluginAdapter<DummyAligner> dummyAlignerAdapter;
...
vampGetPluginDescriptor(unsigned int version, unsigned int index)
{
    ...
    switch (index) {
    case  0: return dummyAlignerAdapter.getDescriptor();
    default: return 0;
    }
}
